...
NUMBER_FIELDS = (models.IntegerField, models.PositiveSmallIntegerField, models.PositiveIntegerField, models.FloatField)
...
ALIGNMENT_CLASS = {ALIGNMENT_CHOICE_LEFT: '', ALIGNMENT_CHOICE_CENTRE: 'dt-center', ALIGNMENT_CHOICE_RIGHT: 'dt-right'}

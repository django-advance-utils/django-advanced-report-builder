...
AGGREGATE_CLASSES = (Sum, Avg, Max, Min, Count)
...
DATE_FORMAT_TYPES_MOMENT_FORMAT = {
    ...
    DATE_FORMAT_TYPE_MM_DD_YY_DASH: 'MM-DD-YY',
    DATE_FORMAT_TYPE_MM_DD_YYYY_DASH: 'MM-DD-YYYY',
    DATE_FORMAT_TYPE_WORDS_MM_DD_YYYY: 'MMMM DD YYYY',
    DATE_FORMAT_TYPE_WORDS_DD_MM_YYYY: 'DD MMMM YYYY',
    DATE_FORMAT_TYPE_SHORT_WORDS_MM_DD_YYYY: 'MMM DD YYYY',
    DATE_FORMAT_TYPE_SHORT_WORDS_DD_MM_YYYY: 'DD MMM YYYY',
    DATE_FORMAT_TYPE_YYYY: 'YYYY',
    DATE_FORMAT_TYPE_YY: 'YY',
    DATE_FORMAT_TYPE_MM_YY: 'MM YY',
    DATE_FORMAT_TYPE_YYYY_MM: 'YYYY MM',
    DATE_FORMAT_TYPE_MM_YYYY: 'MM YYYY',
    DATE_FORMAT_TYPE_WORDS_MM_YY: 'MMMM YY',
    DATE_FORMAT_TYPE_WORDS_MM_YYYY: 'MMMM YYYY',
    DATE_FORMAT_TYPE_SHORT_WORDS_MM_YY: 'MMM YY',
    DATE_FORMAT_TYPE_SHORT_WORDS_MM_YYYY: 'MMM YYYY',
    DATE_FORMAT_TYPE_MM: 'MM',
    DATE_FORMAT_TYPE_WORDS_MM: 'MMMM',
    DATE_FORMAT_TYPE_SHORT_WORDS_MM: 'MMM',
    DATE_FORMAT_TYPE_WW: 'WW',
    DATE_FORMAT_TYPE_WW_YYYY_DASH: 'WW-YYYY',
    DATE_FORMAT_TYPE_WW_YY_DASH: 'WW-YY',
}

PREFIX_TYPE_AUTOMATIC = 0
PREFIX_TYPE_NONE = 1
PREFIX_TYPE_CUSTOM = 2

PREFIX_TYPE_CHOICES = [
    (PREFIX_TYPE_AUTOMATIC, 'Automatic'),
    (PREFIX_TYPE_NONE, 'None'),
    (PREFIX_TYPE_CUSTOM, 'Custom'),
]

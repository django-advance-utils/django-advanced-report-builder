...
class ReportUtilsMixin(ReportBuilderFieldUtils, FilterQueryMixin):
    ...
    def _set_multiple_title(database_values, value_prefix, fields, text, null_text=''):
        ...
        Lives here rather than on the table and chart mixins separately: they had a copy each, and
        the copies drifted -- a bar chart split on a nullable field headed its NULL series "None"
        while the breakdown table beside it used the configured name.

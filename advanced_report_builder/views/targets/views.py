...
from advanced_report_builder.form_utils import PercentageWidget
...
class TargetModal(ModelFormModal):
    model = Target
    form_fields = ['name', 'target_type', 'period_type', 'default_colour', 'default_value']

    process = PROCESS_EDIT_DELETE
    permission_delete = PERMISSION_OFF

    def form_setup(self, form, *_args, **_kwargs):
        fields = ['name', 'target_type', 'period_type', 'default_colour', 'default_value']
